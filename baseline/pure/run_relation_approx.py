...
from relation.models import BertForRelationApprox, LongformerForRelationApprox
        ...
        for i, sent in enumerate(doc):     
            ...
            for x in range(len(sent_ner)):
                for y in range(len(sent_ner)):
                    ...
                    #print(sent_start+obj.span.start_sent, sent_start+obj.span.end_sent, obj.span.start_sent, obj.span.end_sent)
...
def evaluate(model, device, eval_dataloader, e2e_ngold=None, verbose=True):
    ...
    all_preds = []
    all_labels = []
    for input_ids, input_position, input_mask, segment_ids, labels, sub_obj_ids, sub_obj_masks in tqdm(eval_dataloader):
        batch_labels = labels
...
def main(args):
    ...
    elif args.model == 'allenai/longformer-base-4096':
        RelationModel = LongformerForRelationApprox
    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", default=None, type=str, required=True, help="The model, for instance 'allenai/longformer-base-4096'")
    ...
    parser.add_argument("--entity_predictions_test", type=str, default="ent_pred_dev.json", help="The entity prediction file of the test set")
    ...
    parser.add_argument('--task', type=str, default=None, required=True, choices=['ace04', 'ace05', 'scierc', 'docred'])
